...
class ConsoleRenderer implements Renderer{
	...
	private static final Map<Board.Mark, String[]> MARKS_DRAWINGS = Map.of(
	
		Board.Mark.X, new String[] {"  X   X  ",
									"    X    ",
									"  X   X  "      },
							   
		Board.Mark.O, new String[] {"   OOO   ",
									"  O   O  ",
									"   OOO   "      },

		Board.Mark.BLANK, new String[] {"         ",
									    "         ",
									    "         "    }
	);
	...
	*/
	...
	public void drawMarkInBuffer(int rowStart, int colStart, Board.Mark mark) {
